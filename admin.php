 ...
 <div class="container-fluid">    
	...
	<div class="col-md-4 col-sm-4 col-xs-12"></div>
	      <div class="col-md-4 col-sm-4 col-xs-12"> 
		           <form   style="background-color: cyan; border: 1px solid; margin-top: 10vh; -webkit-box-shadow: 0px 2px 78px 16px rgba(20,13,20,1); padding: 35px 45px;" class="form-container" action="admin.php" method="post">
  ...
  <input type="submit" name="login" class="btn btn-success btn-block" value="login" > <br>
		      ...
		      <?php
			       if(isset($_POST['login']))
				   {
					   ...
					   if($password=='pass@123'&& $email='admin@gmail.com')
					   {
